...
\begin{table}[!h]
	\small
		\begin{tabular}{l l |p{100mm} }
			...
			10.10.-26.11.2017 & 50h & Developing Android Apps -MOOC -kurssi\\
			20.-25.11.2017 & 16h & Harjoitus 4, Laskukone\\
			25.-26.11.2017 & 10h & Harjoitus 5 ja 6, Tietokanta\\
			26.11.-27.12.2017 & 30h & Laaja harjoitustyö\\
...
Julkinen git-repo perustettu GitHubiin.
...
https://github.com/mpanu/tut-mobiili/tree/master/CsoundAndroid/ThereminSeq
...
Soitto-toiminta käynnistyy vasemman yläkulman toggle-buttonilla. Resursseista luetaan accel\_osc.csd -tiedosto ja se tallennetaan cache-hakemistoon jotta Csound pystyy lukemaan sen. CsoundMotion on wrapper-luokka yllämainitulle CsoundAccelerometerBinding -luokalle joka välittää kiihtyvyysanturin tiedot Csoundille. Se myös pitää näytön päällä soiton ajan jotta nuottien tallennus soiton yhteydessä on mahdollista.
